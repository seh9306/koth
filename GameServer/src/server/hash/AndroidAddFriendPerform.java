...
public class AndroidAddFriendPerform implements SignalPerform {

	private GameDAO gameDAO;
	private ResultSet rs;
	
	public AndroidAddFriendPerform(Server server) {
	...
	public void performAction(ClientSocketThread clientSocketThread, SignalKey key) {
			...
			AndroidAddFriendKey androidAddFriendKey = (AndroidAddFriendKey) key;
			
			String myID = androidAddFriendKey.getMyID();
			String friendID = androidAddFriendKey.getFriendID();
			
			String updateQuery = "INSERT INTO `koth`.`friend_info` (`user_id`, `friend_id`) "
